...
# Define a new 3x3 grid with obstacles and different numbers
new_matrix = [
    [5, 2, 3],
    [4, 6, 2],
    [2, 3, 7]
...
# Define new start and end positions
new_start_pos = (0, 0)
new_end_pos = (2, 2)

# Find the path using the A* algorithm
new_path, new_cost = a_star(new_matrix, new_start_pos, new_end_pos)

# Print the results
if new_path:
    print("Path found:", new_path)
    print("Minimum Path Cost:", new_cost)
else:
    print("No path found.")
